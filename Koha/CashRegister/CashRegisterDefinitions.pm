package Koha::CashRegister::CashRegisterDefinitions;
...
Koha::CashRegister::CashRegisterDefinitions - Cash registers class
...
sub object_class {
    return 'Koha::CashRegister::CashRegisterDefinition';
}
