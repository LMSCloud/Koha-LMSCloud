...
=head3 new
    ...
    The type key is mandatory, see @Koha::Statistic::allowed_accounts_types,
    @Koha::Statistic::allowed_circulation_types, or
    @Koha::Statistic::allowed_authentication_types.
