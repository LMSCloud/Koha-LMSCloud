...
<xslo:stylesheet xmlns:xslo="http://www.w3.org/1999/XSL/Transform" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:z="http://indexdata.com/zebra-2.0" xmlns:kohaidx="http://www.koha-community.org/schemas/index-defs" xmlns:exsl="http://exslt.org/common" extension-element-prefixes="exsl" version="1.0">
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='072']">
    <xslo:for-each select="marc:subfield">
      <xslo:if test="contains('a', @code)">
        <z:index name="Subject-genre-form:w">
          <xslo:value-of select="."/>
        </z:index>
      </xslo:if>
    </xslo:for-each>
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='153']">
    <xslo:for-each select="marc:subfield">
      <xslo:if test="contains('a', @code)">
        <z:index name="Kateg-No:n Kateg-No:p">
          <xslo:value-of select="."/>
        </z:index>
      </xslo:if>
    </xslo:for-each>
    ...
    <xslo:for-each select="marc:subfield">
      <xslo:if test="contains('j', @code)">
        <z:index name="Kateg-Name:w Kateg-Name:p">
          <xslo:value-of select="."/>
        </z:index>
      </xslo:if>
    </xslo:for-each>
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='852']">
    <xslo:for-each select="marc:subfield">
      <xslo:if test="contains('a', @code)">
        <z:index name="Systematik:w Systematik:p">
          <xslo:value-of select="."/>
        </z:index>
      </xslo:if>
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='856']">
    ...
    <xslo:if test="contains($linkname, 'Antolin')">
      ...
      <xslo:for-each select="marc:subfield[@code='z']">
        <z:index name="Antolin-age:w Antolin-age:p">
          <xslo:variable name="raw_heading">
            <xslo:value-of select="$linkname"/>
            <xslo:value-of select="substring(' ', 1, 1)"/>
            <xslo:value-of select="."/>
          </xslo:variable>
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='900']">
    <xslo:for-each select="marc:subfield">
      <xslo:if test="contains('a', @code)">
        <z:index name="Author:w Author:p">
          <xslo:value-of select="."/>
  ...
  <xslo:template mode="index_subfields" match="marc:datafield[@tag='945']">
    <xslo:if test="@ind1='a' and @ind2='f'">
      <xslo:for-each select="marc:subfield">
        <xslo:if test="contains('a', @code)">
          <z:index name="EKZFsk:n EKZFsk:p">
            <xslo:value-of select="."/>
          </z:index>
        </xslo:if>
      </xslo:for-each>
    </xslo:if>
    <xslo:if test="@ind1='a' and @ind2='u'">
      <xslo:for-each select="marc:subfield">
        <xslo:if test="contains('a', @code)">
          <z:index name="EKZUsk:n EKZUsk:p">
            <xslo:value-of select="."/>
          </z:index>
        </xslo:if>
      </xslo:for-each>
    </xslo:if>
    <xslo:if test="@ind1='a' and @ind2='a'">
      <xslo:for-each select="marc:subfield">
        <xslo:if test="contains('a', @code)">
          <z:index name="EKZAge:n EKZAge:p">
            <xslo:value-of select="."/>
          </z:index>
        </xslo:if>
      </xslo:for-each>
  ...
  <xslo:template mode="index_data_field" match="marc:datafield[@tag='084']">
    <xslo:variable name="classification">
      <xslo:value-of select="marc:subfield[@code='2']"/>
    </xslo:variable>
    <xslo:for-each select="marc:subfield[@code='a']">
      <z:index name="Local-classification:w Local-classification:p Local-classification:s">
        <xslo:variable name="raw_heading">
            <xslo:value-of select="$classification"/>
            <xslo:value-of select="substring(' ', 1, 1)"/>
            <xslo:value-of select="."/>
        </xslo:variable>
        <xslo:value-of select="normalize-space($raw_heading)"/>
  ...
  <xslo:template mode="index_facets" match="marc:datafield[@tag='072']">
