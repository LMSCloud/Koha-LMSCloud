...
my $as_values =
    {}; # hash for storing all read records from table aggregated_statistics_values for one statistics_id, with aggregated_statistics_values.name as key

# general information / 1. ALLGEMEINE ANGABEN
$as_values->{'gen_dbs_id'} =
    { 'id' => '', 'name' => 'gen_dbs_id', 'value' => '', 'type' => 'text' };    # DBS2017:0 (for cvs downloads)
$as_values->{'gen_population'} = { 'id' => '', 'name' => 'gen_population', 'value' => '', 'type' => 'int' }; # DBS2017:1
$as_values->{'gen_libcount'} =
    { 'id' => '', 'name' => 'gen_libcount', 'value' => '', 'type' => 'int' };  # DBS2017:2 (input locked since DBS 2022)
$as_values->{'gen_branchcount'} = {
    'id'   => '', 'name' => 'gen_branchcount', 'value' => '',
    'type' => 'int'
};                                                                             # DBS2017:3 (input locked since DBS 2022)
$as_values->{'gen_buscount'} =
    { 'id' => '', 'name' => 'gen_buscount', 'value' => '', 'type' => 'int' };  # DBS2017:4 (input locked since DBS 2022)
$as_values->{'gen_extservlocation'} =
    { 'id' => '', 'name' => 'gen_extservlocation', 'value' => '', 'type' => 'int' };    # DBS2017:5
$as_values->{'gen_publicarea'} =
    { 'id' => '', 'name' => 'gen_publicarea', 'value' => '', 'type' => 'float' };       # DBS2017:6
$as_values->{'gen_publicarea_central'} = {
    'id'   => '', 'name' => 'gen_publicarea_central', 'value' => '',
    'type' => 'float'
};    # DBS2018:6.1 (new since DBS 2018)
$as_values->{'gen_openinghours_year'} =
    { 'id' => '', 'name' => 'gen_openinghours_year', 'value' => '', 'type' => 'float' };    # DBS2017:7
$as_values->{'gen_openinghours_year_open_library'} = {
    'id'   => '', 'name' => 'gen_openinghours_year_open_library', 'value' => '',
    'type' => 'float'
};    # DBS2019:7.1 (new since DBS 2019)
$as_values->{'gen_extra_services_yn'} = {
    'id'   => '', 'name' => 'gen_extra_services_yn', 'value' => '',
    'type' => 'bool'
};    # DBS2021:7.2 (new since DBS 2021)
$as_values->{'gen_openinghours_week'} =
    { 'id' => '', 'name' => 'gen_openinghours_week', 'value' => '', 'type' => 'float' };    # DBS2017:8
$as_values->{'gen_openinghours_week_open_library'} = {
    'id'   => '', 'name' => 'gen_openinghours_week_open_library', 'value' => '',
    'type' => 'float'
};    # DBS2019:8.1 (new since DBS 2019)

# patron information / 2. BENUTZER
$as_values->{'pat_active'} = {
    'id'    => '', 'name' => 'pat_active', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['pat_active']
};    # DBS2017:9 (no export since DBS 2021)
$as_values->{'pat_active_to_12'} = {
    'id'    => '', 'name' => 'pat_active_to_12', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['pat_active_to_12']
};    # DBS2017:10.1 (no export since DBS 2021)
$as_values->{'pat_active_from_60'} = {
    'id'    => '', 'name' => 'pat_active_from_60', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['pat_active_from_60']
};    # DBS2017:10.2 (no export since DBS 2021)
$as_values->{'pat_active_below_18'} = {
    'id'    => '', 'name' => 'pat_active_below_18', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['pat_active_below_18']
};    # DBS2021:10.3 (no export since DBS 2021)
$as_values->{'pat_new_registrations'} = {
    'id'    => '', 'name' => 'pat_new_registrations', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['pat_new_registrations']
};    # DBS2017:11 (no export since DBS 2021)
$as_values->{'pat_visits'}      = { 'id' => '', 'name' => 'pat_visits', 'value' => '', 'type' => 'int' };   # DBS2017:12
$as_values->{'pat_visits_virt'} = { 'id' => '', 'name' => 'pat_visits_virt', 'value' => '', 'type' => 'int'
}; # input deactivated                                                                           # DBS2017:12.1 (input locked since DBS 2019)

# media offers and usage / 3. MEDIENANGEBOTE UND NUTZUNG
$as_values->{'med_tot_phys_stock'} = {
    'id'    => '', 'name' => 'med_tot_phys_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_tot_phys_stock']
};    # DBS2017:13
$as_values->{'med_tot_issues'} = {
    'id'    => '', 'name' => 'med_tot_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_tot_issues']
};    # DBS2017:14
$as_values->{'med_phys_issues'} = {
    'id'    => '', 'name' => 'med_phys_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_phys_issues']
};    # DBS2017:14.1
$as_values->{'med_openaccess_stock'} = {
    'id'    => '', 'name' => 'med_openaccess_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_openaccess_stock']
};    # DBS2017:15
$as_values->{'med_openaccess_issues'} = {
    'id'    => '', 'name' => 'med_openaccess_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_openaccess_issues']
};    # DBS2017:16
$as_values->{'med_stack_stock'} = {
    'id'    => '', 'name' => 'med_stack_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_stack_stock']
};    # DBS2017:17
$as_values->{'med_print_stock'} = {
    'id'    => '', 'name' => 'med_print_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_print_stock']
};    # DBS2017:18
$as_values->{'med_print_issues'} = {
    'id'    => '', 'name' => 'med_print_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_print_issues']
};    # DBS2017:19
...
$as_values->{'med_juvenile_stock'} = {
    'id'    => '', 'name' => 'med_juvenile_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_juvenile_stock']
};    # DBS2017:24
$as_values->{'med_juvenile_issues'} = {
    'id'    => '', 'name' => 'med_juvenile_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_juvenile_issues']
};    # DBS2017:25
...
$as_values->{'med_nonbook_tot_stock'} = {
    'id'    => '', 'name' => 'med_nonbook_tot_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_nonbook_tot_stock']
};    # DBS2017:28
$as_values->{'med_nonbook_tot_issues'} = {
    'id'    => '', 'name' => 'med_nonbook_tot_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_nonbook_tot_issues']
};    # DBS2017:29
...
$as_values->{'med_virtsupply_stock'} =
    { 'id' => '', 'name' => 'med_virtsupply_stock', 'value' => '', 'type' => 'int' };    # DBS2017:34
$as_values->{'med_virtconsort_stock'} =
    { 'id' => '', 'name' => 'med_virtconsort_stock', 'value' => '', 'type' => 'int' };    # DBS2017:34.1

#$as_values->{'med_consort_libcount'} = { 'id' => '', 'name' => 'med_consort_libcount', 'value' => '', 'type' => 'int' };                                                                                        # DBS2017:34.2 (dropped since DBS 2023)
$as_values->{'med_virtsupply_issues'} =
    { 'id' => '', 'name' => 'med_virtsupply_issues', 'value' => '', 'type' => 'int' };    # DBS2017:35
$as_values->{'med_access_units'} = {
    'id'    => '', 'name' => 'med_access_units', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_access_units']
};                                                                                        # DBS2017:36
$as_values->{'med_access_units_donated'} =
    { 'id' => '', 'name' => 'med_access_units_donated', 'value' => '', 'type' => 'int' };    # DBS2022:36.1
...
$as_values->{'med_database_cnt'} =
    { 'id' => '', 'name' => 'med_database_cnt', 'value' => '', 'type' => 'int' };            # DBS2017:38
$as_values->{'med_database_login_cnt'} = {
    'id'    => '', 'name' => 'med_database_login_cnt', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_database_login_cnt']
};    # DBS2019:38.1 (new since DBS 2019) (no export since DBS 2022)
$as_values->{'med_database_authsso_yn'} = {
    'id'   => '', 'name' => 'med_database_authsso_yn', 'value' => '',
    'type' => 'bool'
};    # DBS2019:38.2 (new since DBS 2019, always true with Divibib) (no export since DBS 2022)
$as_values->{'med_database_use_cnt'} = {
    'id'   => '', 'name' => 'med_database_use_cnt', 'value' => '',
    'type' => 'int'
};    # DBS2024:38.3 (new since DBS 2024)
$as_values->{'med_subscription_print'} = {
    'id'    => '', 'name' => 'med_subscription_print', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['med_subscription_print']
};    # DBS2017:39
$as_values->{'med_subscription_elect'} =
    { 'id' => '', 'name' => 'med_subscription_elect', 'value' => '', 'type' => 'int' };    # DBS2017:40

#$as_values->{'med_blockcollection_rcvd'} = { 'id' => '', 'name' => 'med_blockcollection_rcvd', 'value' => '', 'type' => 'int' };                                                                                # DBS2017:41  (dropped since DBS 2019)
$as_values->{'med_blockcollection_used_yn'} = {
    'id'   => '', 'name' => 'med_blockcollection_used_yn', 'value' => '',
    'type' => 'bool'
};    # DBS2019:41.1 (new since DBS 2019)

#$as_values->{'med_blockcollection_lent'} = { 'id' => '', 'name' => 'med_blockcollection_lent', 'value' => '', 'type' => 'int' };                                                                                # DBS2017:42 (dropped since DBS 2019)
$as_values->{'med_ILL_borrowing_orders'} =
    { 'id' => '', 'name' => 'med_ILL_borrowing_orders', 'value' => '', 'type' => 'int' };    # DBS2017:43
$as_values->{'med_ILL_lending_orders'} =
    { 'id' => '', 'name' => 'med_ILL_lending_orders', 'value' => '', 'type' => 'int' };      # DBS2017:44

#$as_values->{'med_document_delivery'} = { 'id' => '', 'name' => 'med_document_delivery', 'value' => '', 'type' => 'int' };                                                                                      # DBS2017:45 (dropped since DBS 2019)

# finance / 4. FINANZEN
$as_values->{'fin_current_expenses_tot'} =
    { 'id' => '', 'name' => 'fin_current_expenses_tot', 'value' => '', 'type' => 'float' };    # DBS2017:49
$as_values->{'fin_cur_exp_acquisitions'} =
    { 'id' => '', 'name' => 'fin_cur_exp_acquisitions', 'value' => '', 'type' => 'float' };    # DBS2017:50
$as_values->{'fin_cur_exp_acq_licences'} =
    { 'id' => '', 'name' => 'fin_cur_exp_acq_licences', 'value' => '', 'type' => 'float' };    # DBS2017:50.1
$as_values->{'fin_cur_exp_staff'} =
    { 'id' => '', 'name' => 'fin_cur_exp_staff', 'value' => '', 'type' => 'float' };           # DBS2017:51
$as_values->{'fin_cur_exp_other'} =
    { 'id' => '', 'name' => 'fin_cur_exp_other', 'value' => '', 'type' => 'float' };           # DBS2017:52
$as_values->{'fin_singulary_investments'} =
    { 'id' => '', 'name' => 'fin_singulary_investments', 'value' => '', 'type' => 'float' };    # DBS2017:53
$as_values->{'fin_expenses_tot'} =
    { 'id' => '', 'name' => 'fin_expenses_tot', 'value' => '', 'type' => 'float' };             # DBS2017:54

#$as_values->{'fin_costunit_funds_tot'} = { 'id' => '', 'name' => 'fin_costunit_funds_tot', 'value' => '', 'type' => 'float' };                                                                                  # DBS2017:54.1 (not used since DBS 2018)
$as_values->{'fin_costunit_expenses'} =
    { 'id' => '', 'name' => 'fin_costunit_expenses', 'value' => '', 'type' => 'float' };        # DBS2017:55
$as_values->{'fin_external_funds_tot'} =
    { 'id' => '', 'name' => 'fin_external_funds_tot', 'value' => '', 'type' => 'float' };       # DBS2017:56
$as_values->{'fin_ext_funds_EU'} =
    { 'id' => '', 'name' => 'fin_ext_funds_EU', 'value' => '', 'type' => 'float' };             # DBS2017:57
$as_values->{'fin_ext_funds_national'} =
    { 'id' => '', 'name' => 'fin_ext_funds_national', 'value' => '', 'type' => 'float' };       # DBS2017:58
$as_values->{'fin_ext_funds_fedstate'} =
    { 'id' => '', 'name' => 'fin_ext_funds_fedstate', 'value' => '', 'type' => 'float' };       # DBS2017:59
$as_values->{'fin_ext_funds_communal'} =
    { 'id' => '', 'name' => 'fin_ext_funds_communal', 'value' => '', 'type' => 'float' };       # DBS2017:60
$as_values->{'fin_ext_funds_church'} =
    { 'id' => '', 'name' => 'fin_ext_funds_church', 'value' => '', 'type' => 'float' };         # DBS2017:61
$as_values->{'fin_ext_funds_other'} =
    { 'id' => '', 'name' => 'fin_ext_funds_other', 'value' => '', 'type' => 'float' };          # DBS2017:62
$as_values->{'fin_lib_revenue'} =
    { 'id' => '', 'name' => 'fin_lib_revenue', 'value' => '', 'type' => 'float' };              # DBS2017:63
$as_values->{'fin_user_charge_yn'} =
    { 'id' => '', 'name' => 'fin_user_charge_yn', 'value' => '', 'type' => 'bool' };            # DBS2017:65

# staff capacity / 5. PERSONALKAPAZITÄT
$as_values->{'stf_staff_scheme_appointments'} =
    { 'id' => '', 'name' => 'stf_staff_scheme_appointments', 'value' => '', 'type' => 'float' };    # DBS2017:66
$as_values->{'stf_staff_cnt'} = { 'id' => '', 'name' => 'stf_staff_cnt', 'value' => '', 'type' => 'int' };  # DBS2017:67
$as_values->{'stf_capacity_FTE'} =
    { 'id' => '', 'name' => 'stf_capacity_FTE', 'value' => '', 'type' => 'float' };                         # DBS2017:68
$as_values->{'stf_cap_FTE_librarians'} =
    { 'id' => '', 'name' => 'stf_cap_FTE_librarians', 'value' => '', 'type' => 'float' };                   # DBS2017:69
$as_values->{'stf_cap_FTE_assistants'} =
    { 'id' => '', 'name' => 'stf_cap_FTE_assistants', 'value' => '', 'type' => 'float' };                   # DBS2017:70
$as_values->{'stf_cap_FTE_promotional'} =
    { 'id' => '', 'name' => 'stf_cap_FTE_promotional', 'value' => '', 'type' => 'float' };                  # DBS2017:72
$as_values->{'stf_cap_FTE_others'} =
    { 'id' => '', 'name' => 'stf_cap_FTE_others', 'value' => '', 'type' => 'float' };                       # DBS2017:74
$as_values->{'stf_honorary_cnt'} =
    { 'id' => '', 'name' => 'stf_honorary_cnt', 'value' => '', 'type' => 'int' };                           # DBS2017:75
$as_values->{'stf_cap_FTE_honorary'} =
    { 'id' => '', 'name' => 'stf_cap_FTE_honorary', 'value' => '', 'type' => 'float' };                     # DBS2017:76
$as_values->{'stf_apprentices_cnt'} =
    { 'id' => '', 'name' => 'stf_apprentices_cnt', 'value' => '', 'type' => 'int' };                        # DBS2017:77
$as_values->{'stf_advanced_training_hrs'} =
    { 'id' => '', 'name' => 'stf_advanced_training_hrs', 'value' => '', 'type' => 'float' };                # DBS2017:78
...
$as_values->{'srv_patron_workplaces'} =
    { 'id' => '', 'name' => 'srv_patron_workplaces', 'value' => '', 'type' => 'int' };    # DBS2017:80
$as_values->{'srv_pat_workplc_inclopac'} =
    { 'id' => '', 'name' => 'srv_pat_workplc_inclopac', 'value' => '', 'type' => 'int' };    # DBS2017:81
$as_values->{'srv_pat_workplc_web'} =
    { 'id' => '', 'name' => 'srv_pat_workplc_web', 'value' => '', 'type' => 'int' };         # DBS2017:82
$as_values->{'srv_libhomepage_yn'} =
    { 'id' => '', 'name' => 'srv_libhomepage_yn', 'value' => '', 'type' => 'bool' };         # DBS2017:83
$as_values->{'srv_webopac_yn'} =
    { 'id' => '', 'name' => 'srv_webopac_yn', 'value' => '', 'type' => 'bool' };             # DBS2017:85
$as_values->{'srv_interactive_yn'} =
    { 'id' => '', 'name' => 'srv_interactive_yn', 'value' => '', 'type' => 'bool' };         # DBS2017:86
$as_values->{'srv_socialweb_yn'} =
    { 'id' => '', 'name' => 'srv_socialweb_yn', 'value' => '', 'type' => 'bool' };           # DBS2017:87
$as_values->{'srv_emailquery_yn'} =
    { 'id' => '', 'name' => 'srv_emailquery_yn', 'value' => '', 'type' => 'bool' };          # DBS2017:88
$as_values->{'srv_virtualstock_yn'} =
    { 'id' => '', 'name' => 'srv_virtualstock_yn', 'value' => '', 'type' => 'bool' };        # DBS2017:89
$as_values->{'srv_activeinfo_yn'} =
    { 'id' => '', 'name' => 'srv_activeinfo_yn', 'value' => '', 'type' => 'bool' };          # DBS2017:90
$as_values->{'srv_publicwlan_yn'} =
    { 'id' => '', 'name' => 'srv_publicwlan_yn', 'value' => '', 'type' => 'bool' };          # DBS2017:91
$as_values->{'srv_socialwork_yn'} =
    { 'id' => '', 'name' => 'srv_socialwork_yn', 'value' => '', 'type' => 'bool' };          # DBS2017:92
$as_values->{'srv_coops_tot'} =
    { 'id' => '', 'name' => 'srv_coops_tot', 'value' => '', 'type' => 'int' };    # DBS2021:93 (new since DBS 2021)
$as_values->{'srv_coops_stipulated'} = {
    'id'   => '', 'name' => 'srv_coops_stipulated', 'value' => '',
    'type' => 'int'
};                                                                                # DBS2021:93.1 (new since DBS 2021)
$as_values->{'srv_events_tot'} =
    { 'id' => '', 'name' => 'srv_events_tot', 'value' => '', 'type' => 'int' };    # DBS2017:94
$as_values->{'srv_events_tot_visits'} = {
    'id'   => '', 'name' => 'srv_events_tot_visits', 'value' => '',
    'type' => 'int'
};    # DBS2018:94.1 DBS2019:99.1 (new since DBS 2018) (99.1 since DBS 2019)
$as_values->{'srv_evt_online'} =
    { 'id' => '', 'name' => 'srv_evt_online', 'value' => '', 'type' => 'int' };    # DBS2021:94.2 (new since DBS 2021)
$as_values->{'srv_evt_libintro'} =
    { 'id' => '', 'name' => 'srv_evt_libintro', 'value' => '', 'type' => 'int' };    # DBS2017:95
$as_values->{'srv_evt_juvenile'} =
    { 'id' => '', 'name' => 'srv_evt_juvenile', 'value' => '', 'type' => 'int' };    # DBS2017:96
$as_values->{'srv_evt_adult'} = { 'id' => '', 'name' => 'srv_evt_adult', 'value' => '', 'type' => 'int' };  # DBS2017:97
$as_values->{'srv_evt_exhibition'} =
    { 'id' => '', 'name' => 'srv_evt_exhibition', 'value' => '', 'type' => 'int' };                         # DBS2017:98
$as_values->{'srv_evt_other'} = { 'id' => '', 'name' => 'srv_evt_other', 'value' => '', 'type' => 'int' };  # DBS2017:99
$as_values->{'srv_evt_onl_visits'} =
    { 'id' => '', 'name' => 'srv_evt_onl_visits', 'value' => '', 'type' => 'int' };  # DBS2021:99.2 (new since DBS 2021)
$as_values->{'srv_school_libs'} =
    { 'id' => '', 'name' => 'srv_school_libs', 'value' => '', 'type' => 'int' };     # DBS2017:100
$as_values->{'srv_admin_libs'} =
    { 'id' => '', 'name' => 'srv_admin_libs', 'value' => '', 'type' => 'int' };      # DBS2017:101
$as_values->{'srv_contracts'} = { 'id' => '', 'name' => 'srv_contracts', 'value' => '', 'type' => 'int' }; # DBS2017:102
$as_values->{'srv_rfidcheckio_yn'} =
    { 'id' => '', 'name' => 'srv_rfidcheckio_yn', 'value' => '', 'type' => 'bool' };                       # DBS2017:103
$as_values->{'srv_mobiledevices_yn'} =
    { 'id' => '', 'name' => 'srv_mobiledevices_yn', 'value' => '', 'type' => 'bool' };                     # DBS2017:104
$as_values->{'srv_circleoffriends_yn'} = {
    'id'   => '', 'name' => 'srv_circleoffriends_yn', 'value' => '',
    'type' => 'bool'
};    # DBS2026:150 (new since DBS 2026)
$as_values->{'srv_remarks'} = { 'id' => '', 'name' => 'srv_remarks', 'value' => '', 'type' => 'text' };    # DBS2017:199

# patients' libraries / 7. PATIENTENBIBLIOTHEKEN
$as_values->{'ptl_clinical_network_yn'} =
    { 'id' => '', 'name' => 'ptl_clinical_network_yn', 'value' => '', 'type' => 'bool' };                  # DBS2017:200
$as_values->{'ptl_clinet_clinics'} =
    { 'id' => '', 'name' => 'ptl_clinet_clinics', 'value' => '', 'type' => 'int' };                        # DBS2017:201
$as_values->{'ptl_clinet_patientslibs'} =
    { 'id' => '', 'name' => 'ptl_clinet_patientslibs', 'value' => '', 'type' => 'int' };                   # DBS2017:202
$as_values->{'ptl_clinic_beds'} =
    { 'id' => '', 'name' => 'ptl_clinic_beds', 'value' => '', 'type' => 'int' };                           # DBS2017:203
$as_values->{'ptl_outpatients'} =
    { 'id' => '', 'name' => 'ptl_outpatients', 'value' => '', 'type' => 'int' };                           # DBS2017:204
$as_values->{'ptl_trolley_service_yn'} =
    { 'id' => '', 'name' => 'ptl_trolley_service_yn', 'value' => '', 'type' => 'bool' };                   # DBS2017:205
$as_values->{'ptl_trolley_service_hrs'} =
    { 'id' => '', 'name' => 'ptl_trolley_service_hrs', 'value' => '', 'type' => 'float' };                 # DBS2017:206
$as_values->{'ptl_laptop_service_yn'} =
    { 'id' => '', 'name' => 'ptl_laptop_service_yn', 'value' => '', 'type' => 'bool' };                    # DBS2017:207
$as_values->{'ptl_mediaplayer_service_yn'} =
    { 'id' => '', 'name' => 'ptl_mediaplayer_service_yn', 'value' => '', 'type' => 'bool' };               # DBS2017:208
$as_values->{'ptl_medical_lib_yn'} =
    { 'id' => '', 'name' => 'ptl_medical_lib_yn', 'value' => '', 'type' => 'bool' };                       # DBS2017:209
$as_values->{'ptl_combined_lib_yn'} =
    { 'id' => '', 'name' => 'ptl_combined_lib_yn', 'value' => '', 'type' => 'bool' };                      # DBS2017:210
...
$as_values->{'mol_vehicles'} = {
    'id'   => '', 'name' => 'mol_vehicles', 'value' => '',
    'type' => 'int'
};    # DBS2017:300 DBS2024:dropped SQL query since not possible for valuation date
$as_values->{'mol_multiple_communes_yn'} =
    { 'id' => '', 'name' => 'mol_multiple_communes_yn', 'value' => '', 'type' => 'bool' };    # DBS2017:301
...
$as_values->{'mol_stop_stations'} = {
    'id'   => '', 'name' => 'mol_stop_stations', 'value' => '',
    'type' => 'int'
};    # DBS2017:302 DBS2024:dropped SQL query since not possible for valuation date
$as_values->{'mol_cycle_days'} =
    { 'id' => '', 'name' => 'mol_cycle_days', 'value' => '', 'type' => 'int' };    # DBS2017:303
$as_values->{'mol_openinghours_week'} =
    { 'id' => '', 'name' => 'mol_openinghours_week', 'value' => '', 'type' => 'float' };    # DBS2017:304
$as_values->{'mol_stock_media_units'} = {
    'id'    => '', 'name' => 'mol_stock_media_units', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mol_stock_media_units']
};                                                                                          # DBS2017:305
$as_values->{'mol_media_unit_issues'} = {
    'id'    => '', 'name' => 'mol_media_unit_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mol_media_unit_issues']
};                                                                                          # DBS2017:307

# music libraries / 9. MUSIKBIBLIOTHEKEN
$as_values->{'mus_sheetmusic_stock'} = {
    'id'    => '', 'name' => 'mus_sheetmusic_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_sheetmusic_stock']
};                                                                                          # DBS2017:400
$as_values->{'mus_sheetmusic_issues'} = {
    'id'    => '', 'name' => 'mus_sheetmusic_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_sheetmusic_issues']
};                                                                                          # DBS2017:401
$as_values->{'mus_secondarylit_stock'} = {
    'id'    => '', 'name' => 'mus_secondarylit_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_secondarylit_stock']
};                                                                                          # DBS2017:402
$as_values->{'mus_secondarylit_issues'} = {
    'id'    => '', 'name' => 'mus_secondarylit_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_secondarylit_issues']
};                                                                                          # DBS2017:403
$as_values->{'mus_cd_stock'} = {
    'id'    => '', 'name' => 'mus_cd_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_cd_stock']
};                                                                                          # DBS2017:404
$as_values->{'mus_cd_issues'} = {
    'id'    => '', 'name' => 'mus_cd_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_cd_issues']
};                                                                                          # DBS2017:405
$as_values->{'mus_cassette_stock'} = {
    'id'    => '', 'name' => 'mus_cassette_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_cassette_stock']
};                                                                                          # DBS2017:406
$as_values->{'mus_cassette_issues'} = {
    'id'    => '', 'name' => 'mus_cassette_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_cassette_issues']
};                                                                                          # DBS2017:407
$as_values->{'mus_record_stock'} = {
    'id'    => '', 'name' => 'mus_record_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_record_stock']
};                                                                                          # DBS2017:408
$as_values->{'mus_record_issues'} = {
    'id'    => '', 'name' => 'mus_record_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_record_issues']
};                                                                                          # DBS2017:409
$as_values->{'mus_VHS_stock'} = {
    'id'    => '', 'name' => 'mus_VHS_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_VHS_stock']
};                                                                                          # DBS2017:410
$as_values->{'mus_VHS_issues'} = {
    'id'    => '', 'name' => 'mus_VHS_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_VHS_issues']
};                                                                                          # DBS2017:411
$as_values->{'mus_DVD_stock'} = {
    'id'    => '', 'name' => 'mus_DVD_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_DVD_stock']
};                                                                                          # DBS2017:412
$as_values->{'mus_DVD_issues'} = {
    'id'    => '', 'name' => 'mus_DVD_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_DVD_issues']
};                                                                                          # DBS2017:413
$as_values->{'mus_periodicals_stock'} = {
    'id'    => '', 'name' => 'mus_periodicals_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_periodicals_stock']
};                                                                                          # DBS2017:414
$as_values->{'mus_periodicals_issues'} = {
    'id'    => '', 'name' => 'mus_periodicals_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_periodicals_issues']
};                                                                                          # DBS2017:415
$as_values->{'mus_other_stock'} = {
    'id'    => '', 'name' => 'mus_other_stock', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_other_stock']
};                                                                                          # DBS2017:416
$as_values->{'mus_other_issues'} = {
    'id'    => '', 'name' => 'mus_other_issues', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_other_issues']
};                                                                                          # DBS2017:417
$as_values->{'mus_stock_tot'} = {
    'id'    => '', 'name' => 'mus_stock_tot', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_stock_tot']
};                                                                                          # DBS2017:418
$as_values->{'mus_issues_tot'} = {
    'id'    => '', 'name' => 'mus_issues_tot', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['mus_issues_tot']
};                                                                                          # DBS2017:419
$as_values->{'mus_audioplaybacks'} =
    { 'id' => '', 'name' => 'mus_audioplaybacks', 'value' => '', 'type' => 'int' };         # DBS2017:420
$as_values->{'mus_acq_expenses'} =
    { 'id' => '', 'name' => 'mus_acq_expenses', 'value' => '', 'type' => 'float' };         # DBS2017:421

# school libraries / 10. SCHULBIBLIOTHEKEN
$as_values->{'slb_schools_cnt'} =
    { 'id' => '', 'name' => 'slb_schools_cnt', 'value' => '', 'type' => 'int' };            # DBS2021:500
$as_values->{'slb_scs_cnt_prim'} =
    { 'id' => '', 'name' => 'slb_scs_cnt_prim', 'value' => '', 'type' => 'int' };           # DBS2021:501
$as_values->{'slb_scs_cnt_sec1'} =
    { 'id' => '', 'name' => 'slb_scs_cnt_sec1', 'value' => '', 'type' => 'int' };           # DBS2021:502
$as_values->{'slb_scs_cnt_sec2'} =
    { 'id' => '', 'name' => 'slb_scs_cnt_sec2', 'value' => '', 'type' => 'int' };           # DBS2021:503
$as_values->{'slb_scs_cnt_trade'} =
    { 'id' => '', 'name' => 'slb_scs_cnt_trade', 'value' => '', 'type' => 'int' };          # DBS2021:504
$as_values->{'slb_members_cnt'} =
    { 'id' => '', 'name' => 'slb_members_cnt', 'value' => '', 'type' => 'int' };            # DBS2021:505
$as_values->{'slb_pupils_cnt'} =
    { 'id' => '', 'name' => 'slb_pupils_cnt', 'value' => '', 'type' => 'int' };             # DBS2021:506
$as_values->{'slb_teachers_cnt'} =
    { 'id' => '', 'name' => 'slb_teachers_cnt', 'value' => '', 'type' => 'int' };           # DBS2021:507
$as_values->{'slb_publicarea'} =
    { 'id' => '', 'name' => 'slb_publicarea', 'value' => '', 'type' => 'int' };             # DBS2021:508
$as_values->{'slb_openinghours_year'} =
    { 'id' => '', 'name' => 'slb_openinghours_year', 'value' => '', 'type' => 'int' };      # DBS2021:509
$as_values->{'slb_visits_year'} =
    { 'id' => '', 'name' => 'slb_visits_year', 'value' => '', 'type' => 'int' };            # DBS2021:510
$as_values->{'slb_print_stock_tot'} = {
    'id'    => '', 'name' => 'slb_print_stock_tot', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['slb_print_stock_tot']
};                                                                                          # DBS2021:511
$as_values->{'slb_print_stock_educ'} =
    { 'id' => '', 'name' => 'slb_print_stock_educ', 'value' => '', 'type' => 'int' };       # DBS2021:512
$as_values->{'slb_print_issues_tot'} = {
    'id'    => '', 'name' => 'slb_print_issues_tot', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['slb_print_issues_tot']
};                                                                                          # DBS2021:513
$as_values->{'slb_nonbook_stock_tot'} = {
    'id'    => '', 'name' => 'slb_nonbook_stock_tot', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['slb_nonbook_stock_tot']
};                                                                                          # DBS2021:514
$as_values->{'slb_nonbook_issues_tot'} = {
    'id'    => '', 'name' => 'slb_nonbook_issues_tot', 'value' => '', 'type' => 'int', 'calc' => \&func_call_sql,
    'param' => ['slb_nonbook_issues_tot']
};                                                                                          # DBS2021:515
$as_values->{'slb_lms_use_yn'} =
    { 'id' => '', 'name' => 'slb_lms_use_yn', 'value' => '', 'type' => 'bool' };            # DBS2021:516
$as_values->{'slb_emed_access_yn'} =
    { 'id' => '', 'name' => 'slb_emed_access_yn', 'value' => '', 'type' => 'bool' };        # DBS2021:517
$as_values->{'slb_workplaces_onl'} =
    { 'id' => '', 'name' => 'slb_workplaces_onl', 'value' => '', 'type' => 'int' };         # DBS2021:518
$as_values->{'slb_staff_cnt'} = { 'id' => '', 'name' => 'slb_staff_cnt', 'value' => '', 'type' => 'int' }; # DBS2021:519
$as_values->{'slb_stf_lib_qualif_fte'} =
    { 'id' => '', 'name' => 'slb_stf_lib_qualif_fte', 'value' => '', 'type' => 'float' };                  # DBS2021:520
$as_values->{'slb_stf_educ_qualif_fte'} =
    { 'id' => '', 'name' => 'slb_stf_educ_qualif_fte', 'value' => '', 'type' => 'float' };                 # DBS2021:521
$as_values->{'slb_volunteer_cnt'} =
    { 'id' => '', 'name' => 'slb_volunteer_cnt', 'value' => '', 'type' => 'int' };                         # DBS2021:522
$as_values->{'slb_workhours_week'} =
    { 'id' => '', 'name' => 'slb_workhours_week', 'value' => '', 'type' => 'int' };                        # DBS2021:523
$as_values->{'slb_libedu_events_tot'} =
    { 'id' => '', 'name' => 'slb_libedu_events_tot', 'value' => '', 'type' => 'int' };                     # DBS2021:524
$as_values->{'slb_libedu_evt_libuse'} =
    { 'id' => '', 'name' => 'slb_libedu_evt_libuse', 'value' => '', 'type' => 'int' };                     # DBS2021:525
$as_values->{'slb_libedu_evt_meduse'} =
    { 'id' => '', 'name' => 'slb_libedu_evt_meduse', 'value' => '', 'type' => 'int' };                     # DBS2021:526
$as_values->{'slb_libedu_evt_visits'} =
    { 'id' => '', 'name' => 'slb_libedu_evt_visits', 'value' => '', 'type' => 'int' };                     # DBS2021:527
$as_values->{'slb_expenses_tot'} =
    { 'id' => '', 'name' => 'slb_expenses_tot', 'value' => '', 'type' => 'float' };                        # DBS2021:528
...
$as_values->{'sls_assoc_lib_cnt'} =
    { 'id' => '', 'name' => 'sls_assoc_lib_cnt', 'value' => '', 'type' => 'int' };    # DBS2021:550
$as_values->{'sls_consulting_yn'} =
    { 'id' => '', 'name' => 'sls_consulting_yn', 'value' => '', 'type' => 'bool' };    # DBS2021:551
$as_values->{'sls_staff_operat_evt_yn'} =
    { 'id' => '', 'name' => 'sls_staff_operat_evt_yn', 'value' => '', 'type' => 'bool' };    # DBS2021:552
$as_values->{'sls_media_budget_yn'} =
    { 'id' => '', 'name' => 'sls_media_budget_yn', 'value' => '', 'type' => 'bool' };        # DBS2021:553
$as_values->{'sls_stock_creat_yn'} =
    { 'id' => '', 'name' => 'sls_stock_creat_yn', 'value' => '', 'type' => 'bool' };         # DBS2021:554
$as_values->{'sls_it_service_yn'} =
    { 'id' => '', 'name' => 'sls_it_service_yn', 'value' => '', 'type' => 'bool' };          # DBS2021:555
$as_values->{'sls_class_set_provis_yn'} =
    { 'id' => '', 'name' => 'sls_class_set_provis_yn', 'value' => '', 'type' => 'bool' };    # DBS2021:556
$as_values->{'sls_med_collection_yn'} =
    { 'id' => '', 'name' => 'sls_med_collection_yn', 'value' => '', 'type' => 'bool' };      # DBS2021:557

my $dbs_sql_statements =
    {};    # hash for storing the sql statements for calculating DBS values based on standard Koha DB tables

# DBS2017:9    # filtered out from csv export since DBS2021
$dbs_sql_statements->{'pat_active'} = q{
    select count(*) as res from borrowers
    where (@startdatum := ?) <= (@enddatum := ?) 
      and dateexpiry > @enddatum
...
$dbs_sql_statements->{'pat_active_to_12'} = q{
    ...
    where (@startdatum := ?) <= (@enddatum := ?) 
      ...
      and DATE_ADD(dateofbirth, INTERVAL 12 YEAR) > @enddatum
};
...
$dbs_sql_statements->{'pat_active_below_18'} = q{
    ...
    where (@startdatum := ?) <= (@enddatum := ?) 
      ...
      and DATE_ADD(dateofbirth, INTERVAL 18 YEAR) > @enddatum
...
$dbs_sql_statements->{'med_tot_phys_stock'} = q{
    ...
    (   select count(*) as cnt from items 
        where (@startdatum := ?) <= (@enddatum := ?) 
          and ( itemlost = 0 or date(itemlost_on) > @enddatum ) 
          and ( withdrawn = 0 or date(withdrawn_on) > @enddatum ) 
...
$dbs_sql_statements->{'med_subscription_print'} = q{
    ...
    (   select count(*) as cnt from subscription s, subscriptionhistory h
        where (@startdatum := ?) <= (@enddatum := ?) 
          and ( s.subscriptionid = h.subscriptionid ) 
          and ( s.enddate > @enddatum ) 
...
sub new {
    ...
    $self->{'selectedgroup'} = $input->param('selectedgroup')
        || '*';    # default, in case it can not be read from table aggregated_statistics_parameters
...
sub add_form {
    ...
    print STDERR "C4::AggregatedStatistics::DBS::add_form input->param('statisticstype')",
        scalar $input->param('statisticstype'), ": input->param('name')", scalar $input->param('name'), ":\n"
        if $debug;
    print STDERR
        "C4::AggregatedStatistics::DBS::add_form self->{'id'}:$self->{'id'}: self->{'statisticstype'}:$self->{'statisticstype'}: self->{'name'}:$self->{'name'}: self->{'startdate'}:$self->{'startdate'}: self->{'enddate'}:$self->{'enddate'}:\n"
        if $debug;
    print STDERR "C4::AggregatedStatistics::DBSClass::add_form input->param('selectedgroup')",
        scalar $input->param('selectedgroup'),  ": input->param('selectedbranch')",
        scalar $input->param('selectedbranch'), ":\n"
        if $debug;
    ...
    if ( defined($aggregated_statistics_id) && length($aggregated_statistics_id) > 0 ) {
        ...
        print STDERR
            "C4::AggregatedStatistics::DBS::add_form_parameters sel:name='branchgroup'   count aggregatedStatisticsParameters:",
            $aggregatedStatisticsParameters->_resultset() + 0, ":\n"
            if $debug;
        if (   $aggregatedStatisticsParameters
            && $aggregatedStatisticsParameters->_resultset()
            && $aggregatedStatisticsParameters->_resultset()->first() )
        {
        ...
        print STDERR
            "C4::AggregatedStatistics::DBS::add_form_parameters sel:name='branchcode'   count aggregatedStatisticsParameters:",
            $aggregatedStatisticsParameters->_resultset() + 0, ":\n"
            if $debug;
        if (   $aggregatedStatisticsParameters
            && $aggregatedStatisticsParameters->_resultset()
    ...
    &read_categories_and_branches()
        ; # sets variables @categories and @branchloop, which are required for the HTML form part added by aggregated-statistics-parameters-DBS.inc
...
sub add_validate {
    ...
    print STDERR "C4::AggregatedStatistics::DBS::add_validate input->param(selectedgroup):",
        scalar $input->param('selectedgroup'),  ": input->param(selectedbranch):",
        scalar $input->param('selectedbranch'), ":\n"
        if $debug;
    ...
    if ( defined($new_id) && length($new_id) > 0 ) {
        ...
        my $selParam = { statistics_id => $new_id };
        $res = C4::AggregatedStatistics::DelAggregatedStatisticsParameters($selParam)
            ;    # delete all entries from aggregated_statistics_parameters where statistics_id = $id
...
sub copy_ag_values {
    ...
    if (   defined($id_source)
        && length($id_source) > 0
        && defined($id_target)
        && length($id_target) > 0
        && $id_source ne $id_target )
    {
        my $selParam = { statistics_id => $id_target };
        $res = C4::AggregatedStatistics::DelAggregatedStatisticsValues($selParam)
            ;    # delete all entries from aggregated_statistics_parameters where statistics_id = $id_target
        ...
        print STDERR "C4::AggregatedStatistics::DBS::copy_ag_values  count aggregatedStatisticsValues:",
            $aggregatedStatisticsValues->_resultset() + 0, ":\n"
            if $debug;
        if (   $aggregatedStatisticsValues
            && $aggregatedStatisticsValues->_resultset()
            && $aggregatedStatisticsValues->_resultset()->all() )
        {
            foreach my $rsHit ( $aggregatedStatisticsValues->_resultset()->all() ) {
                print STDERR "C4::AggregatedStatistics::DBS::copy_ag_values  rsHit statistics_id:",
                    $rsHit->get_column('statistics_id'), ": name:", $rsHit->get_column('name'), ": value:",
                    $rsHit->get_column('value'), ":\n"
                    if $debug;
...
sub recalculate_ag_values {
    ...
    print STDERR
        "C4::AggregatedStatistics::DBS::recalculate_ag_values startdateDB:$startdateDB: enddateDB:$enddateDB: self->id:$self->{'id'}:\n"
        if $debug;
    ...
    foreach my $name ( sort keys %{$as_values} ) {
        if ( defined( $as_values->{$name}->{'calc'} ) ) {
            $res = &{ $as_values->{$name}->{'calc'} }(
                $name,          $as_values->{$name}->{'param'}, $startdateDB, $enddateDB, $branchgroupSel, $branchgroup,
                $branchcodeSel, $branchcode
            );

            print STDERR
                "C4::AggregatedStatistics::DBS::recalculate_ag_values loop self->id:$self->{'id'}: name:$name: res:$res:\n"
                if $debug;
            C4::AggregatedStatistics::UpdAggregatedStatisticsValues(
                {
...
sub get_branchgroup_branchcode_selection {
    ...
    if ( !defined($branchcode) || length($branchcode) == 0 || $branchcode eq '*' ) {
        ...
        $branchcodeSel = 1;
        $branchgroupSel =
            0;    # of course the finer selection 'branchcode' has to be used, if existing, in favour of 'branchgroup'
    }
...
sub read_categories_and_branches {
    ...
    @categories = ();
    for my $category ( Koha::Library::Groups->get_search_groups( { interface => 'staff' } )->as_list )
    {    # fields used in template: category.id and category.categoryname
        push @categories, { categorycode => $category->id, categoryname => $category->title };
        print STDERR "C4::AggregatedStatistics::DBS::read_categories_and_branches category->unblessed categorycode:",
            $category->description, ": categoryname:", $category->title, ":\n"
            if $debug;
    }
...
sub eval_form {
    ...
    my $res;
    print STDERR
        "C4::AggregatedStatistics::DBS::eval_form Start self->statisticstype:$self->{'statisticstype'}: statisticstypedesignation:$self->{'statisticstypedesignation'}: id:$self->{'id'}: name:$self->{'name'}: startdate:$self->{'startdate'}: enddate:$self->{'enddate'}:\n"
        if $debug;
    ...
    print STDERR
        "C4::AggregatedStatistics::DBS::eval_form branchcode:$branchcode: selectedbranchname:$selectedbranchname:\n"
        if $debug;
    ...
    if ( $self->{'op'} eq 'dcv_calc' ) {
        ...
        foreach my $name ( sort keys %{$as_values} ) {
            ...
            if ( $as_values->{$name}->{'type'} eq 'float' ) {
                ...
                my $thousands_sep = ' '
                    ; # default, correct if Koha.Preference("CurrencyFormat") == 'FR'  (i.e. european format like "1 234 567,89")
        ...
        print STDERR "C4::AggregatedStatistics::DBS::eval_form ref(\$dbs_values):", ref($dbs_values),
            ": statisticstypedesignation:", $self->{'statisticstypedesignation'}, ": id:", $self->{'id'}, ": name:",
            $self->{'name'}, ": startdate:", $self->{'startdate'}, ": enddate:", $self->{'enddate'}, ":\n"
            if $debug;
        if ( ref($dbs_values) eq 'HASH' ) {
            foreach my $name ( keys %{$dbs_values} ) {
                if ( $dbs_values->{$name}->{'type'} eq 'bool' ) {
                    print STDERR "C4::AggregatedStatistics::DBS::eval_form \$dbs_values->{", $name, "}->{'value'}:",
                        $dbs_values->{$name}->{'value'}, ":\n"
                        if $debug;
...
sub dcv_calc {
    ...
    print STDERR "C4::AggregatedStatistics::DBS::dcv_calc Start self->id:", $self->{'id'}, ": self->statisticstype:",
        $self->{'statisticstype'}, ": self->statisticstypedesignation:", $self->{'statisticstypedesignation'},
        ": self->name:", $self->{'name'}, ":\n"
        if $debug;
    ...
    # calculate DBS statistics values where possible
    foreach my $name ( sort keys %{$as_values} ) {
        print STDERR "C4::AggregatedStatistics::DBS::dcv_calc in loop name:", $name, ":\n" if $debug;
        if ( defined( $as_values->{$name}->{'calc'} ) ) {
            $input->{'param'}->{ 'st_' . $name }->[0] = &{ $as_values->{$name}->{'calc'} }(
                $name,        $as_values->{$name}->{'param'}, $self->{'startdate'}, $self->{'enddate'}, $branchgroupSel,
                $branchgroup, $branchcodeSel, $branchcode
            );
        }
    }
}
...
sub dcv_save {
    ...
    my $input = shift;
    my $res;
    print STDERR "C4::AggregatedStatistics::DBS::dcv_save Start self->id:", $self->{'id'}, ": self->statisticstype:",
        $self->{'statisticstype'}, ": self->statisticstypedesignation:", $self->{'statisticstypedesignation'},
        ": self->name:", $self->{'name'}, ":\n"
        if $debug;
    ...
    foreach my $name ( sort keys %{$as_values} ) {
        ...
        print STDERR "C4::AggregatedStatistics::DBS::dcv_save loop self->id:", $self->{'id'},
...
sub getDbsExcludedItemsNotforloan {
    ...
    my $dbsExcludedItemsNotforloan =
        C4::Context->preference("DbsExcludedItemsNotforloan");    # e.g. -1|-2 or empty or undef
    ...
    print STDERR
        "C4::AggregatedStatistics::DBS::getDbsExcludedItemsNotforloan dbsExcludedItemsNotforloan:$dbsExcludedItemsNotforloan:\n"
        if $debug;
    if ($dbsExcludedItemsNotforloan) {
        ...
        foreach my $excludedItemsNotforloanValue (@excludedItemsNotforloanValues) {
            print STDERR
                "C4::AggregatedStatistics::DBS::getDbsExcludedItemsNotforloan excludedItemsNotforloanValue:$excludedItemsNotforloanValue:\n"
                if $debug;
        ...
        print STDERR
            "C4::AggregatedStatistics::DBS::getDbsExcludedItemsNotforloan excludedItemsNotforloanString:$excludedItemsNotforloanString:\n"
            if $debug;
        if ($excludedItemsNotforloanString) {
    ...
    print STDERR
        "C4::AggregatedStatistics::DBS::getDbsExcludedItemsNotforloan returns itemsNotforloanCondition:$itemsNotforloanCondition:\n"
        if $debug;
...
sub func_call_sql {
    ...
    print STDERR
        "C4::AggregatedStatistics::DBS::func_call_sql Start name:$name: startdate:$startdate: enddate:$enddate: branchgroupSel:$branchgroupSel: branchgroup:$branchgroup: branchcodeSel:$branchcodeSel: branchcode:$branchcode:\n"
        if $debug;
