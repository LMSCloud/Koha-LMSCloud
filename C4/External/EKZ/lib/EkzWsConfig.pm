...
sub new {
    ...
    my $ekzAqbooksellersId =
        C4::Context->preference('ekzAqbooksellersId');    # if empty then coupling to Koha acquisition is switched off
    ...
    if ( defined( $ekzAqbooksellersIds[0] ) ) {
        ...
        $self->{'fallBackEkzAqbooksellersId'} =
            '';    # undef and '' signals that coupling to Koha acquisition is switched off
    }
    ...
    $self->{'logger'}
        ->trace( "new() Dumper(ekzWebServicesCustomerNumbers):" . Dumper(@ekzWebServicesCustomerNumbers) . ":" );
    ...
    for ( my $i = 0 ; $i < $ekzWebServicesCustomerNumbersCnt ; $i += 1 ) {
        if ( defined( $ekzWebServicesCustomerNumbers[$i] ) && length( $ekzWebServicesCustomerNumbers[$i] ) ) {
            $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzKundenNr'} =
                $ekzWebServicesCustomerNumbers[$i];
            if ( defined( $ekzWebServicesPasswords[$i] ) && length( $ekzWebServicesPasswords[$i] ) ) {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzPasswort'} =
                    $ekzWebServicesPasswords[$i];
            } else {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzPasswort'} =
                    defined( $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }->{'ekzPasswort'} )
                    ? $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }->{'ekzPasswort'}
                    : 'UNDEFINED';
            }
            if ( defined( $ekzWebServicesUserNames[$i] ) && length( $ekzWebServicesUserNames[$i] ) ) {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzLmsNutzer'} =
                    $ekzWebServicesUserNames[$i];
            } else {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzLmsNutzer'} =
                    defined( $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }->{'ekzLmsNutzer'} )
                    ? $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }->{'ekzLmsNutzer'}
                    : 'UNDEFINED';
            }
            if ( defined( $ekzProcessingNoticesEmailAddresses[$i] )
                && length( $ekzProcessingNoticesEmailAddresses[$i] ) )
            {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }
                    ->{'ekzProcessingNoticesEmailAddress'} = $ekzProcessingNoticesEmailAddresses[$i];
            } else {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }
                    ->{'ekzProcessingNoticesEmailAddress'} =
                    defined( $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }
                        ->{'ekzProcessingNoticesEmailAddress'} )
                    ? $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }
                    ->{'ekzProcessingNoticesEmailAddress'}
                    : 'UNDEFINED';
            }
            if ( defined( $ekzWebServicesDefaultBranches[$i] ) && length( $ekzWebServicesDefaultBranches[$i] ) ) {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzWebServicesDefaultBranch'} =
                    $ekzWebServicesDefaultBranches[$i];
            } else {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzWebServicesDefaultBranch'} =
                    defined(
                    $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }->{'ekzWebServicesDefaultBranch'}
                    )
                    ? $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }
                    ->{'ekzWebServicesDefaultBranch'}
                    : 'UNDEFINED';
            }
            if ( defined( $ekzAqbooksellersIds[$i] ) && length( $ekzAqbooksellersIds[$i] ) ) {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzAqbooksellersId'} =
                    $ekzAqbooksellersIds[$i];
            } else {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzAqbooksellersId'} =
                    defined(
                    $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }->{'ekzAqbooksellersId'} )
                    ? $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }->{'ekzAqbooksellersId'}
                    : '';    # undef and '' signals that coupling to Koha acquisition is switched off
            }
            if ( defined( $ekzAqbudgetperiodsDescriptions[$i] ) && length( $ekzAqbudgetperiodsDescriptions[$i] ) ) {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzAqbudgetperiodsDescription'}
                    = $ekzAqbudgetperiodsDescriptions[$i];
            } else {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzAqbudgetperiodsDescription'}
                    = defined( $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }
                        ->{'ekzAqbudgetperiodsDescription'} )
                    ? $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }
                    ->{'ekzAqbudgetperiodsDescription'}
                    : '';
            }
            if ( defined( $ekzAqbudgetsCodes[$i] ) && length( $ekzAqbudgetsCodes[$i] ) ) {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzAqbudgetsCode'} =
                    $ekzAqbudgetsCodes[$i];
            } else {
                $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] }->{'ekzAqbudgetsCode'} =
                    defined( $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }->{'ekzAqbudgetsCode'} )
                    ? $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[0] }->{'ekzAqbudgetsCode'}
                    : '';
            }
        }
        $self->{'logger'}->trace( "new() Dumper(self->{'ekzCustomerBranch'}->{$ekzWebServicesCustomerNumbers[$i]}):"
                . Dumper( $self->{'ekzCustomerBranch'}->{ $ekzWebServicesCustomerNumbers[$i] } )
                . ":" );
    }
...
sub getEkzKundenNr {
    ...
    if ( defined($ekzCustomerNumber) && length($ekzCustomerNumber) ) {
        if (   defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber} )
            && defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzKundenNr'} ) )
        {
...
sub getEkzPasswort {
    ...
    if ( defined($ekzCustomerNumber) && length($ekzCustomerNumber) ) {
        if (   defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber} )
            && defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzPasswort'} ) )
        {
...
sub getEkzLmsNutzer {
    ...
    if ( defined($ekzCustomerNumber) && length($ekzCustomerNumber) ) {
        if (   defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber} )
            && defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzLmsNutzer'} ) )
        {
...
sub getEkzProcessingNoticesEmailAddress {
    ...
    if ( defined($ekzCustomerNumber) && length($ekzCustomerNumber) ) {
        if (   defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber} )
            && defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzProcessingNoticesEmailAddress'} )
            && $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzProcessingNoticesEmailAddress'} ne 'UNDEFINED' )
        {
...
sub getEkzWebServicesDefaultBranch {
    ...
    if ( defined($ekzCustomerNumber) && length($ekzCustomerNumber) ) {
        if (   defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber} )
            && defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzWebServicesDefaultBranch'} )
            && $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzWebServicesDefaultBranch'} ne 'UNDEFINED' )
        {
...
sub getEkzAqbooksellersId {
    ...
    if ( defined($ekzCustomerNumber) && length($ekzCustomerNumber) ) {
        if (   defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber} )
            && defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzAqbooksellersId'} )
            && $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzAqbooksellersId'} ne 'UNDEFINED' )
        {
...
sub getEkzAqbudgetperiodsDescription {
    ...
    if ( defined($ekzCustomerNumber) && length($ekzCustomerNumber) ) {
        if (   defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber} )
            && defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzAqbudgetperiodsDescription'} )
            && $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzAqbudgetperiodsDescription'} ne 'UNDEFINED' )
        {
            $ret = $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzAqbudgetperiodsDescription'};
        }
    }
    $self->{'logger'}->trace( "getEkzAqbudgetperiodsDescription(ekzCustomerNumber:"
            . ( defined($ekzCustomerNumber) ? $ekzCustomerNumber : 'undef' )
            . ") returns ret:$ret:" );
    return $ret;
}
...
sub getEkzAqbudgetsCode {
    ...
    if ( defined($ekzCustomerNumber) && length($ekzCustomerNumber) ) {
        if (   defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber} )
            && defined( $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzAqbudgetsCode'} )
            && $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzAqbudgetsCode'} ne 'UNDEFINED' )
        {
            $ret = $self->{'ekzCustomerBranch'}->{$ekzCustomerNumber}->{'ekzAqbudgetsCode'};
        }
    }
    $self->{'logger'}->trace( "getEkzAqbudgetsCode(ekzCustomerNumber:"
            . ( defined($ekzCustomerNumber) ? $ekzCustomerNumber : 'undef' )
            . ") returns ret:$ret:" );
    return $ret;
}
