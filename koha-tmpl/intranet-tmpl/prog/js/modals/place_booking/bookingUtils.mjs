...
export function updateExternalDependents(store, newBooking, isUpdate = false) {
    if (typeof window.timeline !== "undefined" && window.timeline !== null) {
        const itemData = {
            ...
            content:
                typeof window.$patron_to_html === "function"
                    ? window.$patron_to_html(
                          !isUpdate && store.bookingPatron
                              ? store.bookingPatron
                              : newBooking.patron,
                          { display_cardnumber: true, url: false }
                      )
                    : !isUpdate &&
                        store.bookingPatron &&
                        store.bookingPatron.cardnumber
                      ? store.bookingPatron.cardnumber
                      : newBooking.patron && newBooking.patron.cardnumber
                        ? newBooking.patron.cardnumber
                        : "",
            type: "range",
