  ...
  methods: {
    ...
    doDelete: function (erm_package, dt, event) {
      this.setConfirmationDialog(
        {
          title: this.$__("Are you sure you want to remove this package?"),
        ...
        () => {
          ...
          client.localPackages.delete(erm_package.package_id).then(
            success => {
              this.setMessage(
                this.$__("Local package %s deleted").format(erm_package.name),
                true
              )
              dt.draw()
            },
    ...
    getTableColumns: function () {
      ...
      return [
        ...
        },
        {
          ...
          render: function (data, type, row, meta) {
            return escape_str(
              get_lib_from_av("av_package_types", row.package_type)
            )
          },
        },
        {
          ...
          render: function (data, type, row, meta) {
            return escape_str(
              get_lib_from_av("av_package_content_types", row.content_type)
            )
          },
        },
        {
