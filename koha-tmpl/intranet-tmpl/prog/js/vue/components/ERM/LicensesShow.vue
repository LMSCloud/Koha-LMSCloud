    ...
    <div>
      <fieldset class="rows">
        <ol>
          ...
          <li>
            <label>{{ $__("Type") }}:</label>
            <span>{{ get_lib_from_av("av_license_types", license.type) }}</span>
          </li>
          <li>
          ...
          <li v-if="license.user_roles.length">
            ...
            <table>
              ...
              <tbody>
                <tr
                  v-for="(role, counter) in license.user_roles"
                  v-bind:key="counter"
                >
      ...
      <AdditionalFieldsDisplay
        ...
        :additional_field_values="license._strings.additional_field_values"
      />
  ...
  methods: {
    ...
    delete_license: function (license_id, license_name) {
      this.setConfirmationDialog(
        {
          title: this.$__("Are you sure you want to remove this license?"),
        ...
        () => {
          ...
          client.licenses.delete(license_id).then(
            success => {
              this.setMessage(
                this.$__("License %s deleted").format(license_name),
                true
              )
