      ...
      <fieldset class="rows">
        <ol>
          ...
          <li v-if="title.date_first_issue_online">
            <label
              >{{ $__("Date of first serial issue available online") }}:</label
            >
            <span>
          ...
          <li v-if="title.num_first_vol_online">
            <label>{{ $__("Number of first volume available online") }}:</label>
            <span>
              {{ title.num_first_vol_online }}
            </span>
          </li>
          <li v-if="title.num_first_issue_online">
            <label>{{ $__("Number of first issue available online") }}:</label>
            <span>
              {{ title.num_first_issue_online }}
            </span>
          </li>
          <li v-if="title.date_last_issue_online">
            <label>{{ $__("Date of last issue available online") }}:</label>
            <span>
              {{ title.date_last_issue_online }}
            </span>
          </li>
          <li v-if="title.num_last_vol_online">
            <label>{{ $__("Number of last volume available online") }}:</label>
            <span>
              {{ title.num_last_vol_online }}
            </span>
          </li>
          <li v-if="title.num_last_issue_online">
            <label>{{ $__("Number of last issue available online") }}:</label>
            <span>
          ...
          <li v-if="title.date_monograph_published_online">
            <label
              >{{ $__("Date the monograph is first published online") }}:</label
            >
            <span>
          ...
          <li v-if="title.monograph_volume">
            <label>{{ $__("Number of volume for monograph") }}:</label>
            <span>
          ...
          <li>
            ...
            <div v-if="title.resources.length">
              <EHoldingsTitlePackagesList :resources="title.resources" />
            </div>
          </li>
        </ol>
      </fieldset>
  ...
  methods: {
    ...
    delete_title: function (title_id, title_publication_title) {
      this.setConfirmationDialog(
        {
          title: this.$__("Are you sure you want to remove this title?"),
