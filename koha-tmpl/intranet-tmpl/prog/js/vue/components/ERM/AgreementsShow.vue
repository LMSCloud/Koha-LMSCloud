<template>
  ...
  <div v-else id="agreements_show">
    <Toolbar>
      ...
      />
      <a
        @click="delete_agreement(agreement.agreement_id, agreement.name)"
    ...
    <div>
      <fieldset class="rows">
        <ol>
          ...
          <li>
            ...
            <span v-if="agreement.is_perpetual">{{ $__("Yes") }}</span>
            ...
            <table>
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    {{ format_date(period.cancellation_deadline) }}
                  </td>
                  <td>{{ period.notes }}</td>
                </tr>
              </tbody>
            ...
            <table>
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    {{ get_lib_from_av("av_user_roles", role.role) }}
                  </td>
                </tr>
              </tbody>
            </table>
                  ...
                  <td>
                    <router-link
                      :to="{
                        name: 'LicensesShow',
                        params: {
                          license_id: agreement_license.license_id,
                        },
                      }"
                    >
                ...
                <span
                  ><router-link
                    :to="{
                      ...
                      params: {
                        agreement_id:
                          relationship.related_agreement.agreement_id,
                      },
                    }"
                    >{{ relationship.related_agreement.name }}</router-link
                  ></span
                >
                {{
                  get_lib_from_av(
              ...
              >
                <span
                  v-if="
                    ...
                    agreement_package.package.provider == 'ebsco'
                  "
                >
                  <router-link
                    :to="{
                      ...
                      params: {
                        package_id: agreement_package.package.external_id,
                      },
                    }"
                    >{{ agreement_package.package.name }}</router-link
                  >
                  {{ $__("(EBSCO)") }}</span
                >
                <span v-else
                  ><router-link
                    :to="{
                      ...
                      params: {
                        package_id: agreement_package.package.package_id,
                      },
                    }"
                    >{{ agreement_package.package.name }}</router-link
                  >
              ...
              <ul>
                ...
                >
                  <div v-if="document.file_name">
                    ...
                    ({{ document.file_type }}) {{ $__("Uploaded on") }}:
      ...
      <AdditionalFieldsDisplay
        ...
        :additional_field_values="agreement._strings.additional_field_values"
      />
  ...
  methods: {
    ...
    delete_agreement: function (agreement_id, agreement_name) {
      this.setConfirmationDialog(
        {
          title: this.$__("Are you sure you want to remove this agreement?"),
        ...
        () => {
          ...
          client.agreements.delete(agreement_id).then(
            success => {
              this.setMessage(
                this.$__("Agreement %s deleted").format(agreement_name),
                true
              )
