<template>
  ...
  <div v-else-if="erm_package" id="packages_show">
    <Toolbar>
      ...
      />
      <a
        @click="delete_package(erm_package.package_id, erm_package.name)"
    ...
    <div>
      <fieldset class="rows">
        <ol>
          ...
          <li>
            ...
            <span>{{
              get_lib_from_av("av_package_types", erm_package.package_type)
            }}</span>
          </li>
          <li>
          ...
          <li>
            <label>{{
              $__("Titles (%s)").format(erm_package.resources_count)
            }}</label>
          </li>
        </ol>
      ...
      <AdditionalFieldsDisplay
        ...
        :additional_field_values="erm_package._strings.additional_field_values"
      />
      ...
      this.setConfirmationDialog(
        ...
        () => {
          ...
          client.localPackages.delete(package_id).then(
            success => {
              this.setMessage(
                this.$__("Local package %s deleted").format(package_name),
                true
              )
              this.$router.push({
