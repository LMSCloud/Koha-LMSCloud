          ...
          <ol>
            ...
            <li>
              <label for="not_for_loan_waiting_list_in"
                >{{ $__("Status for item added to this train") }}:</label
              >
              <v-select
            ...
            <li>
              <label class="required" for="train_default_processing"
  ...
  data() {
    return {
      train: {
        ...
        name: "",
        description: "",
        not_for_loan: this.config.settings.not_for_loan_default_train_in,
