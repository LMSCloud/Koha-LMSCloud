          ...
          <ol>
            ...
            <li>
              <label for="letter_code"
                >{{ $__("Letter template for printing slip") }}:</label
              >
              <v-select
                id="letter_code"
                label="name"
        ...
        <fieldset class="rows">
          ...
          >
            <legend>
              ...
              <a href="#" @click.prevent="deleteAttribute(counter)"
            ...
            <ol>
              <li>
                <label :for="`attribute_name_${counter}`" class="required"
                  >{{ $__("Name") }}:
                </label>
                <input
              ...
              <li>
                <label :for="`attribute_type_${counter}`" class="required"
                  >{{ $__("Type") }}:
                </label>
                <v-select
                  ...
                  :reduce="o => o.code"
                  @option:selected="attribute.option_source = null"
                >
              ...
              <li v-if="attribute.type == 'authorised_value'">
                <label :for="`attribute_option_${counter}`" class="required"
                  >{{ $__("Options") }}:
                </label>
                <v-select
                  ...
                  :getOptionLabel="
                    c =>
                      authorised_value_categories.find(cc => cc == c)
                        ? c
                        : '%s (%s)'.format(c, $__('DOES NOT EXIST!'))
                  "
                >
                  <template #search="{ attributes, events }">
                    <input
          ...
          <a class="btn btn-default" @click="addAttribute"
            ><font-awesome-icon icon="plus" /> {{ $__("Add new attribute") }}</a
          >
        </fieldset>
