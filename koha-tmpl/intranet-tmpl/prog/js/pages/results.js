...
$(document).ready(function () {
    ...
    if (
        PREF_IssuingStatsOnIntranetResultPageYears &&
        PREF_IssuingStatsOnIntranetResultPageYears > 0
    ) {
        getIssuingStatsForBiblios(
            biblionumbersForStats,
            PREF_IssuingStatsOnIntranetResultPageYears,
            IssuingStatsIgnoredItypesForStats,
            IssuingStatsCheckoutTxt,
            IssuingStatsTotalTxt
        );
    }
});
