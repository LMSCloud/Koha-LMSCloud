...
return {
    ...
    description =>
        "Discard notice fees for holds if the home branch is listed with parameter DiscardHoldsNoticeFeeOfHomeLibraries: needed for stack material ordering free of charge.",
    up => sub {
        my ($args) = @_;
