...
return {
    ...
    up          => sub {
        ...
        $dbh->do( "
            ...
            ('HelimaAdditionalOfferName','Hessen-Angebote',NULL,'Name of the Licensor/Provider of the HeLiMa service.','Free'),
            ('HelimaCustomerID','0',NULL,'The customer ID when using the HeLiMa service.','Free'),
