...
--
-- Table structure for table `acquisition_import`
--

DROP TABLE IF EXISTS `acquisition_import`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acquisition_import` (
  `id` int(11) NOT NULL auto_increment COMMENT 'unique key, used to identify the record',
  `vendor_id` varchar(200) NOT NULL default '' COMMENT 'code for identifying the vendor, e.g. "ekz"',
  `object_type` varchar(80) NOT NULL default '' COMMENT 'code of object type, eg. "order", "delivery", "invoice"',
  `object_number` varchar(255) NOT NULL default '' COMMENT 'number of this object, set by vendor',
  `object_date` date NOT NULL COMMENT 'date linked to the object, eg. order date, invoice date',
  `rec_type` varchar(80) NOT NULL default '' COMMENT 'code for type of this record, e.g. "message", "title", "item"',
  `object_item_number` varchar(255) default NULL COMMENT 'number of this object item, set by vendor',
  `processingstate` varchar(80) NOT NULL default '' COMMENT 'code for state of this object item when record was created, e.g. "ordered", "delivered", "invoiced"',
  `processingtime` timestamp NOT NULL default CURRENT_TIMESTAMP COMMENT 'time when record was created',
...
DROP TABLE IF EXISTS `acquisition_import_objects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acquisition_import_objects` (
  `id` int(11) NOT NULL auto_increment COMMENT 'unique key, used to identify the record',
  `acquisition_import_id` int(11) NOT NULL default 0 COMMENT 'foreign key from the acquisition_import table to identify the connection (value of acquisition_import.id)',
  `koha_object` varchar(80) NOT NULL default '' COMMENT 'code of type of created koha object, eg. "title", "item"',
...
DROP TABLE IF EXISTS `aggregated_statistics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aggregated_statistics` (
  `id` int(11) NOT NULL auto_increment COMMENT 'unique key, used to identify the record',
  `type` varchar(80) NOT NULL default '' COMMENT 'code for type of statistic, e.g. "DBS"',
  `name` varchar(200) NOT NULL default '' COMMENT 'name of statistic, eg. "complete DBS 2017"',
  `description` varchar(255) NOT NULL default '' COMMENT 'description of statistic, e.g. "complete DBS for year 2017, sum over branches"',
  `startdate` date NOT NULL COMMENT 'start date of selection period',
  `enddate` date NOT NULL COMMENT 'end date of selection period',
  PRIMARY KEY  (`id`),
  KEY `type` (`type`),
  KEY `name` (`name`)
...
DROP TABLE IF EXISTS `aggregated_statistics_parameters`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aggregated_statistics_parameters` (
  `statistics_id` int(11) NOT NULL COMMENT 'foreign key from the aggregated_statistics table to identify the join (value of aggregated_statistics.id)',
...
DROP TABLE IF EXISTS `aggregated_statistics_values`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aggregated_statistics_values` (
  `statistics_id` int(11) NOT NULL COMMENT 'foreign key from the aggregated_statistics table to identify the join (value of aggregated_statistics.id)',
  `name` varchar(80) NOT NULL default '' COMMENT 'name of the result value, e.g. "med_printissue_stock"',
...
CREATE TABLE `borrower_modifications` (
  ...
  `altcontacttitle` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `borrowers` (
  ...
  `altcontacttitle` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'title of the alternate contact for the patron/borrower',
...
CREATE TABLE `branches` (
  ...
  `mobilebranch` varchar(10) default NULL COMMENT 'marks a branch as bookmobile stop with a reference to the related bookmobile branch',
...
CREATE TABLE `cash_register_account` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID of the cash register account record',
  `cash_register_account_id` int(11) NOT NULL COMMENT 'consecutively numbered transaction per cash register; starts for each cash register with 1',
  `cash_register_id` int(10) NOT NULL COMMENT 'ID of the cash register (cash_register_definition.id)',
  `manager_id` int(11) NOT NULL COMMENT 'the staff member who booked to the cashier (borrowers.borrowernumber)',
  ...
  CONSTRAINT `cash_register_account_fk_1` FOREIGN KEY (`cash_register_id`)
    REFERENCES `cash_register_definition` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Table cash_register_definition
--

-- The table cash_register_definition defines cash registers that can be used in the library. If cash registers
...
DROP TABLE IF EXISTS `cash_register_definition`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cash_register_definition` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID of the cash register',
  `name` varchar(100) NOT NULL COMMENT 'name of the cash register',
  `branchcode` varchar(10) NOT NULL default '' COMMENT 'the branch, in which the cash register is used (branches.branchcode)',
  `manager_id` int(11) COMMENT 'the staff member who currently manages the cash register (borrowers.borrowernumber)',
  `prev_manager_id` int(11) COMMENT 'who was the previous manager of the cash register (borrowers.borrowernumber)',
  `modification_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'when was the entry last time changed',
  `no_branch_restriction` tinyint(1) default 0 COMMENT 'do not restrict the use of the cash register to the owning branch',
   PRIMARY KEY (`id`),
...
CREATE TABLE `cash_register_manager` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID of the cash register manager record',
  `cash_register_id` int(11) NOT NULL COMMENT 'ID of the cash register (cash_register_definition.id)',
  `manager_id` int(11) NOT NULL COMMENT 'the staff member who is allowed to manage the cash register (borrowers.borrowernumber)',
  `modification_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'when was the entry last time changed',
  `authorized_by` varchar(11) COMMENT 'the staff member who authorized the manager to manage the cash register (borrowers.borrowernumber)',
  `opened` BOOLEAN default FALSE COMMENT 'this value is used to mark a manager as active for a register if multiple users are authorized to book to a register simultaneously; a staff member can have only one opened cash',
   PRIMARY KEY (`id`),
...
CREATE TABLE `claiming_rules` (
  ...
  `itemtype` varchar(10) NOT NULL default '' COMMENT 'item type this rule is for (itemtypes.itemtype)',
  `branchcode` varchar(10) NOT NULL default '' COMMENT 'the branch this rule applies to (branches.branchcode)',
  `claim_fee_level1` decimal(28,6) default NULL COMMENT 'fine amount for reaching 1st claim',
  `claim_fee_level2` decimal(28,6) default NULL COMMENT 'fine amount for reaching 2nd claim',
  `claim_fee_level3` decimal(28,6) default NULL COMMENT 'fine amount for reaching 3nd claim',
  `claim_fee_level4` decimal(28,6) default NULL COMMENT 'fine amount for reaching 4nd claim',
  `claim_fee_level5` decimal(28,6) default NULL COMMENT 'fine amount for reaching 5nd claim',
   PRIMARY KEY (`id`),
...
CREATE TABLE `letter` (
  ...
  `code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT 'unique identifier for this notice or slip',
...
CREATE TABLE `message_queue` (
  ...
  CONSTRAINT `messageq_ibfk_3` FOREIGN KEY (`branchcode`) REFERENCES `branches` (`branchcode`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notice_fee_rules` (
  ...
  `categorycode` varchar(10) NOT NULL default '' COMMENT 'patron category this rule is for (categories.categorycode)',
  `branchcode` varchar(10) NOT NULL default '' COMMENT 'the branch this rule applies to (branches.branchcode)',
  `message_transport_type` varchar(10) NOT NULL default '' COMMENT 'message channel this rule is for (message_transport_type.message_transport_types)',
  `letter_code` varchar(50) NOT NULL default '' COMMENT 'optional letter code thise rule is for (letter.code)',
...
CREATE TABLE `overdue_issues` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID of the overdue issue entry',
  `issue_id` int(10) NOT NULL COMMENT 'ID of the issue (refers to issues or old_issues)',
  `claim_level` int(3) NOT NULL COMMENT 'ID claim level based on the overduerules (cash_register.id)',
  `claim_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'when was the item claimed',
   PRIMARY KEY (`id`),
