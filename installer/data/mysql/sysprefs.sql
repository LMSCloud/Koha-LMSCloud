...
('GirosolutionRemittanceInfo','Bibliothek:<<borrowers.cardnumber>>',NULL,'Pattern for constructimg the text for the \'remittance information\' of the payment by replacing the placeholder <<borrowers.cardnumber>> by the patron\'s cardnumber.','Free'),
