...
sub insertinto_authorised_values {
    ...
    foreach my $loadvalue (@$loadvalues) {
        ...
        $sth->execute(
            $loadvalue->{'category'}, $loadvalue->{'authorised_value'}, $loadvalue->{'lib'},
            $loadvalue->{'lib_opac'}, $loadvalue->{'imageurl'}
        );
...
sub insertinto_marc_subfield_structure {
    ...
    foreach my $loadvalue (@$loadvalues) {
        ...
        foreach my $frameworkcode (@frameworkcodes) {
            print "insertinto_marc_subfield_structure: loop loadvalue->{'liblibrarian'}:",
                $loadvalue->{'liblibrarian'}, ": frameworkcode:$frameworkcode:\n";
