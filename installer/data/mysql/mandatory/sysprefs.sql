...
('DefaultPatronLanguage', '', NULL, 'Create new patrons with the given language setting. The value will also be use if parameter TranslateNotices is not activated in order to get translated content of notices correctly.', 'Free'),
('DefaultPatronSearchFields',    'firstname|preferred_name|middle_name|surname|othernames|cardnumber|userid',NULL,'Pipe separated list defining the default fields to be used during a patron search using the "standard" option. If empty Koha will default to "firstname|preferred_name|middle_name|surname|othernames|cardnumber|userid". Additional fields added to this preference will be added as search options in the dropdown menu on the patron search page.','free'),
...
('ILLModuleCopyrightClearance','','','Adding text will enable the copyright clearance stage in ILL request creation.','Textarea'),
...
('NewsMaxNumberOnMainPage','',NULL,'Limit the number of news displayed on the OPAC start page to news with a maximum position number of this value. If empty, all news will be displayed.','Integer'),
...
('OPACAuthorIdentifiers','0','','Display identifiers for authors and contributors in the OPAC detail pages.','YesNo'),
...
('OpacDetailVolumeDisplay','1','','Enable volume display in OPAC detail view.','YesNo'),
...
('OPACResultsSidebar','',NULL,'Include the following HTML under the facets in OPAC search results.','Textarea'),
...
('OPACXSLTVolumeDisplay','default','','Enable XSL stylesheet control over volume display on OPAC','Free'),
...
('OverdueNoticePeriodCalculationMethod','byPreviousClaimLevel','byDate|byPreviousClaimLevel','Create overdue notices not only by date but also consider the previosly reached claim level.','Free'),
...
('PermitConcurrentCashRegisterUsers','0',NULL,'Permit concurrent staff users to book to an opened cash register.', 'YesNo' ),
...
('ReturnBranchBecomesHomeBranch','0',NULL,'If ON, the return library will be set as home branch of an item. The setting is useful for a library system that does not transfer items.','YesNo'),
...
('RFIDWebServiceCheckinBlocker','',NULL,'The RFID batch checkin stops if the checkin page contains elements of the specified jQuery selectors. Overwrite only if you want to change the default: \"#circ_impossible,#circ_needsconfirmation\"','Free'),
('RFIDWebServiceCheckoutBlocker','',NULL,'The RFID batch checkout stops if the checkout page contains elements of the specified jQuery selectors. Overwrite only if you want to change the default: \".problem,.error,.alert,.audio-alert-warning,.audio-aler-action\"','Free'),
...
('SocialNetworks','email,facebook,linkedin,twitter','email|facebook|linkedin|twitter','Enable/Disable social networks links in opac detail pages','multiple'),
